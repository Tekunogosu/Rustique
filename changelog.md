...
* Added new flags to `list`, `--columns`: Lets you show only specific columns, `--output`: Change the output format, currently only for csv, `--file_path`: save the output to a file instead of printing to stdout. 
