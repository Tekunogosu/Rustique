...
pub enum Commands {
    ...
    Misc {
        ...
        #[arg(
            short,
            long = "one-click-setup",
            help = "Set up the 1-click mod installation. Run as root for to install in /usr/share/applications, or as a user for installation in ~/.local/share/applications."
        )]
