use core::config::config_structs::Tables;
use core::config::config_structs::TableSection;
use core::config::config_structs::CellAttr;
use core::config::config_structs::CellColor;
use core::config::flatten_map::FlattenMap;
use std::fmt::Display;
...
use core::config::config_structs::ColumnProperties;
...
pub async fn config_table_cmd(args: &TableArgs) {
